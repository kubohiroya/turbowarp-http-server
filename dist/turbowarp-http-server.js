...
(function (Scratch) {
  ...
  var block_definitions_default = {
  	extensionName: "TurboWarp-HTTP-Server",
  	blocks: [
  		{
  			"opcode": "setServerUrl",
  			"blockType": "COMMAND",
  			"text": "set HTTP bridge URL to [URL]",
  			"description": "Sets the WebSocket URL used to reach the HTTP bridge server.",
  			"arguments": { "URL": {
  				"type": "STRING",
  				"defaultValue": "ws://127.0.0.1:8787/ws"
  			} }
  		},
  		{
  			"opcode": "connect",
  			"blockType": "COMMAND",
  			"text": "connect to HTTP bridge",
  			"description": "Opens a WebSocket connection to the configured HTTP bridge server.",
  			"arguments": {}
  		},
  		{
  			"opcode": "disconnect",
  			"blockType": "COMMAND",
  			"text": "disconnect from HTTP bridge",
  			"description": "Closes the current bridge connection.",
  			"arguments": {}
  		},
  		{
  			"opcode": "isConnected",
  			"blockType": "BOOLEAN",
  			"text": "HTTP bridge connected?",
  			"description": "Reports whether the bridge WebSocket is currently open.",
  			"arguments": {}
  		},
  		{
  			"opcode": "sendText",
  			"blockType": "COMMAND",
  			"text": "send [MESSAGE] to HTTP bridge",
  			"description": "Sends a text message to the connected HTTP bridge server.",
  			"arguments": { "MESSAGE": {
  				"type": "STRING",
  		...
  		},
  		{
  			"opcode": "lastMessage",
  			"blockType": "REPORTER",
  			"text": "last HTTP bridge message",
  			"description": "Returns the most recent text message received from the bridge.",
  			"arguments": {}
  		},
  		{
  			"opcode": "whenHttpRequestReceived",
  			"blockType": "HAT",
  			"text": "when HTTP request received",
  			"description": "Starts a TurboWarp handler thread when the bridge receives an HTTP request.",
  			"arguments": {}
  		},
  		{
  			"opcode": "useHttpRequest",
  			"blockType": "COMMAND",
  			"text": "use HTTP request [ID]",
  			"description": "Selects a pending request context by request ID.",
  			"arguments": { "ID": {
  				"type": "STRING",
  				"defaultValue": "req-1"
  			} }
  		},
  		{
  			...
  			"description": "Returns the current HTTP request ID.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentHttpMethod",
  			"blockType": "REPORTER",
  			"text": "current HTTP method",
  			"description": "Returns the current HTTP request method.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentRequestPath",
  			"blockType": "REPORTER",
  			"text": "current request path",
  			"description": "Returns the current HTTP request path.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentRequestUrl",
  			"blockType": "REPORTER",
  			"text": "current request URL",
  			"description": "Returns the current HTTP request URL.",
  			"arguments": {}
  		},
  		{
  			...
  			"description": "Returns the first value of a request header using case-insensitive lookup.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "accept"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "query parameter [NAME]",
  			"description": "Returns the first query parameter value.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "q"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "path parameter [NAME]",
  			"description": "Returns a route path parameter value.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "id"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "current request body",
  			"description": "Returns the current textual request body, or an empty string for non-text bodies.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentRequestContentType",
  			"blockType": "REPORTER",
  			"text": "current request content type",
  			"description": "Returns the current request Content-Type header.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentRequestClientAddress",
  			"blockType": "REPORTER",
  			"text": "current request client address",
  			"description": "Returns the current request client address when available.",
  			"arguments": {}
  		},
  		{
  		...
  		},
  		{
  			...
  			"description": "Returns the current authentication type, such as digest or oauth.",
  			"arguments": {}
  		},
  		{
  			...
  			"description": "Returns the authenticated username or a stable user-like profile field when available.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentAuthProvider",
  			"blockType": "REPORTER",
  			"text": "current auth provider",
  			"description": "Returns the authentication provider name when available.",
  			"arguments": {}
  		},
  		{
  			"opcode": "currentAuthProfileJson",
  			"blockType": "REPORTER",
  			"text": "current auth profile JSON",
  			"description": "Returns the provider profile object as JSON when available.",
  			"arguments": {}
  		},
  		{
  			"opcode": "authProfileField",
  			"blockType": "REPORTER",
  			"text": "auth profile field [NAME]",
  			"description": "Returns a top-level or dotted field from the provider profile object.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "email"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "current response status",
  			"description": "Returns the response status currently being built.",
  			"arguments": {}
  		},
  		{
  			"opcode": "setHttpStatus",
  			"blockType": "COMMAND",
  			"text": "set HTTP status [STATUS]",
  			"description": "Sets the current response status.",
  			"arguments": { "STATUS": {
  				"type": "NUMBER",
  				"defaultValue": 200
  			} }
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "set response header [NAME] to [VALUE]",
  			"description": "Sets a response header for the current request.",
  			"arguments": {
  				"NAME": {
  					"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "remove response header [NAME]",
  			"description": "Removes a response header for the current request.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "content-type"
  			} }
  		},
  		{
  			...
  			"description": "Returns the first configured response header value.",
  			"arguments": { "NAME": {
  				"type": "STRING",
  				"defaultValue": "content-type"
  			} }
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "set response body [BODY]",
  			"description": "Sets the current response body without completing the response.",
  			"arguments": { "BODY": {
  				"type": "STRING",
  				"defaultValue": "Hello"
  			} }
  		},
  		{
  			"opcode": "sendResponse",
  			"blockType": "COMMAND",
  			"text": "send response [BODY]",
  			"description": "Sets the response body and completes the current request.",
  			"arguments": { "BODY": {
  				"type": "STRING",
  				"defaultValue": "Hello"
  			} }
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "respond with text [BODY]",
  			"description": "Responds with plain text.",
  			"arguments": { "BODY": {
  				"type": "STRING",
  				"defaultValue": "Hello"
  			} }
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "respond with HTML [BODY]",
  			"description": "Responds with HTML.",
  			"arguments": { "BODY": {
  				"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "COMMAND",
  			"text": "record HTTP log [ENTRY]",
  			"description": "Adds a structured HTTP log entry JSON string to the extension log buffer.",
  			"arguments": { "ENTRY": {
  				"type": "STRING",
  				"defaultValue": "{\"method\":\"GET\",\"path\":\"/\",\"status\":200}"
  			} }
  		},
  		{
  			"opcode": "clearHttpLogs",
  			"blockType": "COMMAND",
  			"text": "clear HTTP logs",
  			"description": "Clears the extension log buffer.",
  			"arguments": {}
  		},
  		{
  			"opcode": "httpLogViewerHtml",
  			"blockType": "REPORTER",
  			"text": "HTTP log viewer HTML",
  			"description": "Returns a self-contained virtual-scroll HTML log viewer for buffered HTTP logs.",
  			"arguments": {}
  		},
  		{
  			"opcode": "httpLogViewerHtmlFromJson",
  			"blockType": "REPORTER",
  			"text": "HTTP log viewer HTML from [LOGS]",
  			"description": "Returns a self-contained virtual-scroll HTML log viewer from a JSON array of log entries.",
  			"arguments": { "LOGS": {
  				"type": "STRING",
  				"defaultValue": "[{\"method\":\"GET\",\"path\":\"/\",\"status\":200}]"
  			} }
  		},
  		{
  			...
  			"description": "Creates an empty Markdown builder handle.",
  			"arguments": {}
  		},
  		{
  			"opcode": "markdownHeading",
  			"blockType": "REPORTER",
  			"text": "markdown [DOC] with heading level [LEVEL] [TEXT]",
  			"description": "Appends a Markdown heading and returns the same builder handle.",
  			"arguments": {
  				"DOC": {
  					"type": "STRING",
  					"defaultValue": "md:1"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "markdown [DOC] with paragraph [TEXT]",
  			"description": "Appends a Markdown paragraph and returns the same builder handle.",
  			"arguments": {
  				"DOC": {
  					"type": "STRING",
  					"defaultValue": "md:1"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "markdown [DOC] with bullet [TEXT]",
  			"description": "Appends a Markdown bullet and returns the same builder handle.",
  			"arguments": {
  				"DOC": {
  					"type": "STRING",
  					"defaultValue": "md:1"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "markdown [DOC] with code [CODE] language [LANG]",
  			"description": "Appends a fenced Markdown code block and returns the same builder handle.",
  			"arguments": {
  				"DOC": {
  					"type": "STRING",
  					"defaultValue": "md:1"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "render markdown [DOC]",
  			"description": "Renders a Markdown builder handle to Markdown text.",
  			"arguments": { "DOC": {
  				"type": "STRING",
  				"defaultValue": "md:1"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "new HTML element [TAG]",
  			"description": "Creates an HTML element builder handle.",
  			"arguments": { "TAG": {
  				"type": "STRING",
  				"defaultValue": "div"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "HTML text [TEXT]",
  			"description": "Creates an escaped HTML text node handle.",
  			"arguments": { "TEXT": {
  				"type": "STRING",
  				"defaultValue": "Hello"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "HTML [NODE] with attribute [NAME] [VALUE]",
  			"description": "Sets an escaped attribute on an HTML element and returns the same handle.",
  			"arguments": {
  				"NODE": {
  					"type": "STRING",
  					"defaultValue": "html:1"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "HTML [PARENT] with child [CHILD]",
  			"description": "Appends a child node to an HTML element and returns the parent handle.",
  			"arguments": {
  				"PARENT": {
  					"type": "STRING",
  					"defaultValue": "html:1"
  		...
  		},
  		{
  			"opcode": "renderHtml",
  			"blockType": "REPORTER",
  			"text": "render HTML [NODE]",
  			"description": "Renders an HTML node handle to an HTML fragment.",
  			"arguments": { "NODE": {
  				"type": "STRING",
  				"defaultValue": "html:1"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "render HTML document title [TITLE] body [BODY]",
  			"description": "Renders a full HTML document from an HTML body node handle.",
  			"arguments": {
  				"TITLE": {
  					"type": "STRING",
  					"defaultValue": "Page"
  ...
  function isForbiddenResponseHeader(name) {
  	return [
  		...
  		"transfer-encoding",
  		"upgrade"
  	].includes(normalizeHeaderName(name));
  }
  ...
  var DEFAULT_SERVER_URL = "ws://127.0.0.1:8787/ws";
  ...
  var VOID_HTML_TAGS = /* @__PURE__ */ new Set(["img", "input"]);
  var VALID_ATTRIBUTE = /^[a-zA-Z_:][a-zA-Z0-9:_.-]*$/;
  var VALID_MARKDOWN_LANGUAGE = /^[a-zA-Z0-9_+.-]*$/;
  var HTTP_REQUEST_HAT_OPCODE = `${extensionConfig.id}_whenHttpRequestReceived`;
  ...
  var URL_LIST_ATTRIBUTES = /* @__PURE__ */ new Set(["srcset"]);
  ...
  var TurboWarpHttpServerExtension = class {
  	...
  	authProfileField(args) {
  		const profile = this.currentContext()?.request.auth?.profile;
  		return stringifyProfileValue(readProfileField(profile, Scratch.Cast.toString(args.NAME)));
  	}
  	...
  	setResponseHeader(args) {
  		...
  		if (validateHeaderName(name) && validateHeaderValue(value) && !isForbiddenResponseHeader(name)) context.response.headers[name] = [value];
  	}
  	...
  	setResponseBody(args) {
  		...
  		context.response.body = {
  			kind: "text",
  			text: Scratch.Cast.toString(args.BODY)
  		};
  	}
  	sendResponse(args) {
  		const context = this.mutableCurrentContext();
  	...
  	htmlSetAttribute(args) {
  		...
  		const value = Scratch.Cast.toString(args.VALUE);
  		if (node?.kind === "element" && VALID_ATTRIBUTE.test(name) && !normalizedName.startsWith("on") && isSafeAttributeValue(normalizedName, value)) node.attributes[name] = value;
  		return handle;
  	}
  	htmlAppendChild(args) {
  		...
  		if (parent?.kind === "element" && this.htmlNodes.has(childHandle) && parentHandle !== childHandle && !this.hasHtmlDescendant(childHandle, parentHandle, /* @__PURE__ */ new Set())) parent.children.push(childHandle);
  		return parentHandle;
  	}
  	renderHtml(args) {
  	...
  	renderHtmlDocument(args) {
  		return `<!doctype html><html><head><meta charset="utf-8"><title>${escapeHtml(Scratch.Cast.toString(args.TITLE))}</title></head><body>${this.renderHtmlNode(Scratch.Cast.toString(args.BODY), /* @__PURE__ */ new Set())}</body></html>`;
  	}
  	...
  	receiveBridgeMessage(message) {
  		try {
  			...
  			if (parsed.type === "request" && typeof parsed.id === "string") this.acceptBridgeRequest(parsed);
  		} catch {
  			return;
  		}
  	}
  ...
  const logs=${JSON.stringify(logs).replace(/</g, "\\u003c")};const rowHeight=32;const viewport=document.getElementById('viewport');const spacer=document.getElementById('spacer');const rows=document.getElementById('rows');document.getElementById('count').textContent='('+logs.length+')';spacer.style.height=(logs.length*rowHeight)+'px';
  ...
  <\/script></body></html>`;
  	...
  	ensureMarkdownHandle(value) {
  		...
  		return this.newMarkdownDocument();
  	}
  	ensureHtmlElementHandle(value) {
  		const handle = Scratch.Cast.toString(value);
  		if (this.htmlNodes.get(handle)?.kind === "element") return handle;
  	...
  	hasHtmlDescendant(handle, targetHandle, visited) {
  		...
  		return node.children.some((child) => child === targetHandle || this.hasHtmlDescendant(child, targetHandle, visited));
  	}
  	nextHandle(prefix) {
  ...
  function normalizeHeaderRecord(headers) {
  	const normalized = {};
  	for (const [name, values] of Object.entries(headers ?? {})) normalized[normalizeHeaderName(name)] = values.map((value) => String(value));
  	return normalized;
  }
  function normalizeValueRecord(values) {
  	const normalized = {};
  	for (const [name, items] of Object.entries(values ?? {})) normalized[name] = items.map((value) => String(value));
  	return normalized;
  }
  ...
  function normalizeAuthContext(auth) {
  	if (typeof auth !== "object" || auth === null || Array.isArray(auth)) return void 0;
