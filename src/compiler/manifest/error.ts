export type CompilerManifestDiagnosticCode =
...
export class CompilerManifestError extends Error {
  public readonly name = 'CompilerManifestError';

  public constructor(
    public readonly code: CompilerManifestDiagnosticCode,
    message: string,
